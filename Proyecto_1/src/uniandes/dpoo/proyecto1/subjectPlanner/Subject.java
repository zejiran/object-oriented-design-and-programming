...
public class Subject {
	...
	public Subject(String name, int credits, int period, String description, String subjectID) {
		this.name = name;
	...
	public void setCredits(int theCredits) {
	...
	public void saveSubject(String filename){
		try{
			BufferedWriter bw = new BufferedWriter(
				new FileWriter("./data/subjects/"+filename+".txt"));
