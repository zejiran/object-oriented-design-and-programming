...
public class TestProducto
{
     ...
     */
    private TestProducto hijoIzquierda;

    /**
     * Referencia al producto hijo derecha.
     */
    private TestProducto hijoDerecha;
     ...
     * <b>post:</b> Los atributos c�digo, nombre, descripci�n y precio se inicializaron con los valores dados por par�metro. El hijo izquierda y el hijo derecha se
     ...
     * <b>post:</b> Los atributos c�digo, nombre, descripci�n, precio y unidades vendidas se inicializaron con la informaci�n del archivo. El hijo izquierda y el hijo derecha
     ...
     * <b>post: </b>La cantidad de unidades vendidas aument� en la cantidad dada por par�metro.
     ...
     * @param pCodigo C�digo con el cual se realizar� la comparaci�n. pCodigo != null && pCodigo != "".
     * @return Retorna 0 si los 2 c�digos son iguales, 1 si el c�digo del producto es mayor y -1 si es menor.
     */
     ...
     * <b>post:</b> Si no exist�a un producto con el mismo c�digo, se agreg� el producto de tal manera que para cada nodo de este �rbol el hijo izquierda tiene un c�digo menor
     * y el hijo derecha tiene un c�digo mayor.
     * @param pProducto Producto que se va a agregar. pProducto != null.
     * @throws TestAlmacenException Si ya exist�a en el sub�rbol un producto con el c�digo dado.
     */
    ...
    /**
     * Busca un producto por c�digo en el sub�rbol generado a partir de este producto.
     * @param pCodigo C�digo del producto que se esta buscando. pCodigo != null && pCodigo != "".
     * @return Producto con el c�digo dado por par�metro o null si no existe en el sub�rbol un producto con ese c�digo.
     */
