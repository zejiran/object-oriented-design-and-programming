...
public class TestMarca extends TestNodoAlmacen {
	...
	/**
	 * Referencia al producto ra�z del �rbol binario que contiene los productos de
	 * la marca.
	 */
	 ...
	 * <b>post: </b> Se inicializaron los atributos de la clase padre con los
	 * valores dados por par�metro y el tipo respectivo. El producto ra�z se
	 * inicializ� en null.
	 * 
	 * @param pIdentificador Identificador �nico de la marca. pIdentificador != null
	 *                       && pIdentificador != "".
	...
	/**
	 * Construye una nueva marca a partir de la l�nea con la informaci�n general y
	 * el lector para la informaci�n adicional.<br>
	 * <b>post:</b> Se inicializaron los atributos de la clase padre con el nombre
	 * que viene en la l�nea y el tipo respectivo. Se cargaron los productos de la
	 * marca de la informaci�n contenida en el lector.
	 * 
	 * @param pLinea  L�nea que contiene la informaci�n general de la marca. pLinea
	 *                != null && pLinea != "" && pLinea.startsWith(TIPO).
	 * @param pLector Lector para acceder a la informaci�n de los productos.
	 * @throws TestAlmacenException Si ocurren errores al leer la informaci�n de los
	 *                              productos.
	 */
	...
	/**
	 * Agrega un nuevo producto con la informaci�n dada al �rbol de productos de la
	 * marca.<br>
	 ...
	 * @param pDescripcion Descripci�n del producto. pDescripcion != null &&
	 *                     pDescripcion != "".
	 * @param pPrecio      Precio del producto. pPrecio > 0.
	 * @throws TestAlmacenException Si ya exist�a un producto con el c�digo dado.
	 */
	public void agregarProducto(String pCodigo, String pNombre, String pDescripcion, double pPrecio)
			throws TestAlmacenException {
	...
	/**
	 * Vende una cantidad dada del producto con el c�digo recibido por
	 * par�metro.<br>
